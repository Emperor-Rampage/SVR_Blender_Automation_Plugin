...
from . glimmer_ops import Glimmer_OT_LoadXMLFile,Glimmer_OT_LoadCsvFile, Glimmer_OT_MultiRender,Glimmer_OT_NewMultiRender, Glimmer_OT_ScaleObject, Glimmer_OT_UnScaleObject, Glimmer_OT_AddVariation, Glimmer_OT_DeleteVariation
...
class SVR_Settings(bpy.types.PropertyGroup):
    ...
    xmlFile : StringProperty(name="XML Filename")
